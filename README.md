...
## Setup
```
cmsrel CMSSW_10_2_11_
cd CMSSW_10_2_11/
cmsenv
git cms-init
cd src/
git clone https://github.com/VourMa/MLShEx_CorrL1Muons.git --single-branch --branch exercise
scram b -j 4
...
* Understand [_../TMVATraining/TMVARegression.py_](../exercise/Configuration/test/TMVATraining/TMVARegression.py).
* Run
   ```
