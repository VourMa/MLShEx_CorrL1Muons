...
void TMVARegression_Impr_00_08( TString myMethodList = "" )
{
   ...
   TString outfileName( "TMVAReg_Impr_00_08.root" );
   ...
   TMVA::DataLoader *dataloader=new TMVA::DataLoader("dataset_Impr_00_08");
   ...
   //mycut += " (L1muon_tfMuonIndex >= 36 && L1muon_tfMuonIndex <= 70) ";
   mycut += " fabs( L1muon_eta ) < 0.8 ";
