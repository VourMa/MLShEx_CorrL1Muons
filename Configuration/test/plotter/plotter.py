...
if args.test == "Resolutions":
    ...
    for TF in TFs.keys():
        ...
        histoReg.SetName("TMVA"); histoReg.SetTitle("TMVA"); histoReg.Draw("same")
        maxReg = histoCosmetics(histoReg,"TMVA",args.test,"#Delta#phi(L1-Reco)")
    ...
    histoL1Corr = inFile.Get("h_L1mllCorr"); histoL1Corr.SetName("TMVA"); histoL1Corr.SetTitle("TMVA"); histoL1Corr.Draw("same"); maxL1Corr = histoCosmetics(histoL1Corr,"TMVA",args.test,"M_{ll} [GeV]")
    ...
    histoL1Corr = inFile.Get("h_L1Dmll_o_mllCorr_particle"); histoL1Corr.SetName("TMVA"); histoL1Corr.SetTitle("TMVA"); histoL1Corr.Draw("same"); maxL1Corr = histoCosmetics(histoL1Corr,"TMVA",args.test,"(M_{reco} - M_{L1}) / M_{reco} (J/#psi)")
