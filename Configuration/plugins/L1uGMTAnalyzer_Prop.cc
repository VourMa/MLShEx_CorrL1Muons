...
// Class declaration
class L1uGMTAnalyzer_Prop : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
	public:
		explicit L1uGMTAnalyzer_Prop(const edm::ParameterSet&);
		~L1uGMTAnalyzer_Prop();
...
// Constructor
L1uGMTAnalyzer_Prop::L1uGMTAnalyzer_Prop(const edm::ParameterSet& iConfig) :
...
// Destructor
L1uGMTAnalyzer_Prop::~L1uGMTAnalyzer_Prop() {
}

// Method called for each event
void L1uGMTAnalyzer_Prop::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
	using namespace std;
	using namespace edm;
	using namespace l1t;
...
void L1uGMTAnalyzer_Prop::beginJob() {
...
void L1uGMTAnalyzer_Prop::endJob() {
}

// Method that fills 'descriptions' with the allowed parameters for the module
void
L1uGMTAnalyzer_Prop::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(L1uGMTAnalyzer_Prop);
