...
void TMVARegression_Impr_12_24( TString myMethodList = "" )
{
   ...
   TString outfileName( "TMVAReg_Impr_12_24.root" );
   ...
   TMVA::DataLoader *dataloader=new TMVA::DataLoader("dataset_Impr_12_24");
   ...
   dataloader->AddVariable( "L1muon_charge", "charge(L1 #mu)", "", 'F' );
